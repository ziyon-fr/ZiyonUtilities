//
//  ZiyonWrappingHStack.swift
//  Ziyon
//
//  Created by Wellington Nascente Hirsch on 07/09/23.
//

import SwiftUI

/// A view that arranges its subviews in horizontal line and wraps them to the next lines if necessary.
public struct ZiyonWrappingHStack: Layout {
...
// MARK: Preview
struct ZiyonWrappingHStack_Preview: PreviewProvider {
    static var previews: some View {
        NavigationStack {
            ZiyonWrappingHStack(alignment: .leading) {
                ForEach(
